...
/*        CLIENT_CONFIG = CLIENT_BUILDER.build();*/
    ...
    private static void setupWorldGenConfig(){
       ...
       STONEIUM_ORE_VAIN_SIZE = COMMON_BUILDER.comment("Size of a Vain [DEFAULT: 6]")
                .defineInRange("stoneium_ore_vain_size", 6, 1, 50);
        STONEIUM_ORE_VAIN_AMOUNT = COMMON_BUILDER.comment("The Amount of Vains for a chunk [DEFAULT: 10]")
                .defineInRange("stoneium_ore_vain_amount", 10, 0, 100);
    }
}
