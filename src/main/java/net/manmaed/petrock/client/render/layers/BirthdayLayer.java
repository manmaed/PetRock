 ...
 */
public class BirthdayLayer extends RenderLayer {

    private static final ResourceLocation skin = RLHelper.location("textures/entity/event/cake.png");
    private final ModelCakeHat hat;

    public BirthdayLayer(RenderLayerParent layerParent, EntityModelSet p_174494_) {
        super(layerParent);
        this.hat = new ModelCakeHat(p_174494_.bakeLayer(PRModels.CAKE));
