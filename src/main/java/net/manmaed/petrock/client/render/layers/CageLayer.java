 ...
 */
public class CageLayer extends RenderLayer {

    private static final ResourceLocation skin = RLHelper.location("textures/entity/event/cage.png");
    private final ModelCageHat hat;
