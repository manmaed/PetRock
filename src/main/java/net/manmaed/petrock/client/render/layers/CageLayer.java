 ...
 */
public class CageLayer<T extends EntityPetRock, M extends ModelPetRock<T>> extends RenderLayer<T, M> {

    private static final ResourceLocation skin = new ResourceLocation(PetRock.MOD_ID, "textures/entity/event/cage.png");
    private final ModelCageHat<T> hat;

    public CageLayer(RenderLayerParent layerParent, EntityModelSet p_174494_) {
        super(layerParent);
        this.hat = new ModelCageHat<>(p_174494_.bakeLayer(PRModels.CAGE));
