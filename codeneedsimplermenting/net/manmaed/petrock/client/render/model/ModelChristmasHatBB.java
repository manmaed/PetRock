...
public class ModelChristmasHatBB<T extends Entity> extends EntityModel<T> {
	...
	public ModelChristmasHatBB(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hatp5 = partdefinition.addOrReplaceChild("hatp5", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 29.3767F, 12.8941F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -13.6F, 0.0F, -0.4014F, 0.0F, 0.0F));

		PartDefinition ballball = partdefinition.addOrReplaceChild("ballball", CubeListBuilder.create().texOffs(0, 15).addBox(-1.0F, 29.3767F, 12.8941F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -13.2F, 2.1F, -0.4014F, 0.0F, 0.0F));
